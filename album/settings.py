...
ALLOWED_HOSTS = ['album-mundial-flavio.heroku.app', '127.0.0.1', 'localhost']
...
# Sirve para indicar a Django cual sera el modelo que tiene que utilizar para la tabla 'auth_user'
